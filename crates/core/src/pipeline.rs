...
mod tests {
    ...
    impl GitBackend for StubGit {
        ...
        fn stage_paths(&self, _paths: &[String]) -> CoreResult<()> {
            Ok(())
        }
        ...
        fn staged_diff_for_path(&self, path: &str, _max_bytes: u64) -> CoreResult<GitDiff> {
        ...
        fn commit(&self, _message: &str, _edit: bool, _no_verify: bool) -> CoreResult<String> {
            Ok(String::new())
        }
